        ...
        <div role="grid" class="dataTables_wrapper form-inline" id="sample_1_wrapper">
            <div class="row-fluid"><div class="span6">
                ...
                <tr class="odd">
                    ...
                    <td class="hidden-480 ">
                        <a href="<?php echo base_url('group/index/gameid/'.$v['id'])?>">去分组</a>
                        <a href='<?php echo base_url('group/Flight/gameid/'.$v['id'])?>'>添加对战</a>
                        <a href='<?php echo base_url('Fight/list/gameid/'.$v['id'])?>'>对战信息</a>
                        <a href=''>关闭比赛</a></td>
                </tr>
                <?php endforeach;?>
                <?php endif;?>
