        ...
        <div class="span12">
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    ...
                    <hr />
                    <form class="form-horizontal" id='myform' action='<?php echo base_url('video/GoEdit')  ?>' method='post'  >
                            ...
                            <div class="controls">
                                <select tabindex="1" class="small m-wrap" name="item_id">
                                    <?php foreach ($cln as $v):?>
                                        <option value="<?php echo $v['id']?>" <?php if($v['id']==$data['item_id']){echo 'selected="true"';}?>><?php echo $v['name']?></option>
                                    <?php endforeach;?>
                                </select>
                            </div>
                        </div>
                        <div id="html1">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="name" class="b-wrap " data-trigger="hover"  value="<?php echo $data['name']?>"   datatype="*1-116" nullmsg="栏目名称">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <div class="usercr">
                                        ...
                                        <div class="utxtximg">
                                            <img class="zltx" id="header_photo" src="<?php echo base_url().$data['logo']?>" onerror="this.src='<?php echo base_url() ?>images/usertx.png'"  width="100" height="100">
                                        </div>
                                        <div class="txupload">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="checkbox" <?php if($data['status']==1){echo "checked='checked'";}?>name="status" value="1" >
                                    <span class="help-inline  Validform_checktip"></span>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="url" class="b-wrap span12"  data-trigger="hover" value="<?php echo $data['url']?>"  nullmsg="栏目名称">
                                    <span class="help-inline  Validform_checktip"></span>
                                </div>
                            </div>
                            ...
                            <div class="control-group" id="tiaoma">
                                ...
                                <div class="controls">
                                    <textarea class="large m-wrap" rows="6" cols="60" name="intr"><?php echo $data['intr']?></textarea>
                                </div>
                            </div>
