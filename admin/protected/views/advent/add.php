        ...
        <div class="span12">
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    ...
                    <hr />
                    <form class="form-horizontal" id='myform' action='<?php echo base_url('advent/GoAdd')  ?>' method='post'  >
                        ...
                        <div id="html1">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="title" class="b-wrap " data-trigger="hover"     datatype="*1-116" nullmsg="项目/游戏名称">
