        ...
        <div role="grid" class="dataTables_wrapper form-inline" id="sample_1_wrapper">
            <div class="row-fluid"><div class="span6">
                ...
                <tr role="row">
                    ...
                    <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" style="width: 280px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">广告名</th>
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" style="width: 398px;" aria-label="Browser: activate to sort column ascending">显示位置</th>
                    <th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" style="width: 360px;" aria-label="Platform(s): activate to sort column ascending">链接</th>
                ...
                <tr class="odd">
                    ...
                    <td class=" "><?php echo $v['showname']?></td>
                    <td class=" "><?php echo $v['url']?></td>
                    <td class=" "><?php  if($v['status']==1){echo '显示正常';}else{echo '隐藏';}?></td>
                    <td class="hidden-480 "><a href="<?php echo base_url('advent/edit/id/'.$v['id']);?>">查看</a></td>
                </tr>
                <?php endforeach;?>
                <?php endif;?>
               </tbody></table>
